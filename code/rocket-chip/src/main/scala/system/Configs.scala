...
//new WithPARoCCAccel ++ new WithExtMemSize(0x40000000)++
class DefaultConfig extends Config(new WithExtMemSize(0x40000000)++ new WithNBigCores(1) ++ new WithCoherentBusTopology ++ new BaseConfig)
